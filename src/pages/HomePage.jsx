  ...
  return (
    <Layout
      intro={
        <>
          ...
          <br />
          <br />
          I&apos;m a passionate, detailed oriented and self-taught front-end web
          developer with over 19 years&apos; of experience writing HTML, CSS and
          JavaScript to build and maintain websites and applications. I
          specialize in mobile-first, responsive website design with a focus on
          performance, UX, accessibility and search engine optimization.
    ...
    >
      <section className="wideBody panel-elevated">
        <h2>Website Manager, Development Team Lead, and Front-End Developer</h2>
        <p>
      ...
      <section className="homeColumns">
        <section className="thinBody panel-elevated">
          ...
          <ul className="square">
            ...
            <li>
              Team delivery: improving communication, code quality, and release
